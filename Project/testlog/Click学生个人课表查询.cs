...
namespace testlog
{
    public partial class Click学生个人课表查询 : Form
    {
        ...
        private void showTable()
        {
            ...
            while (dr.Read())
            {
                string a, b, c, d, e, f, g, temp1, temp2;
                a = dr["课程"].ToString();
                b = dr["课程号"].ToString();
                c = dr["学分"].ToString();
                d = dr["授课老师"].ToString();
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            {
                String Cno = dataGridView4.SelectedCells[1].Value.ToString();
                string sql = "delete from 课程学生SC where 学号 = '" + Sno + "' and 课程号 = '" + Cno + "'";
