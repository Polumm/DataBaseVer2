...
namespace testlog
{
    public partial class Click修改密码 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "select 用户名, 密码 from " + right1 + "密码表 where 用户名 ='" + UserName1 + "' and 密码 = '" + textBox1.Text + "'";
                Door dr = new Door();
                ...
                else
                {
                    ...
                    {
                        string sql1 = "Update " + right1 + "密码表 set 密码 = '" + textBox3.Text + "' where 用户名 = '"+ UserName1 +"'";
